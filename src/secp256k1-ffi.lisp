...
(defconstant +secp256k1-context-none+
...
(defconstant +secp256k1-context-sign+
  ...
  "Flags to pass to secp256k1_context_create, secp256k1_context_preallocated_size, and secp256k1_context_preallocated_create. ")
(defconstant +secp256k1-context-declassify+
  (logior +secp256k1-flags-type-context+ +secp256k1-flags-bit-context-declassify+)
  "Flags to pass to secp256k1_context_create, secp256k1_context_preallocated_size, and secp256k1_context_preallocated_create. ")

(defconstant +secp256k1-ec-uncompressed+ +secp256k1-flags-type-compression+
  "Flag to pass to secp256k1_ec_pubkey_serialize.")
(defconstant +secp256k1-ec-compressed+ (logior +secp256k1-flags-type-compression+ +secp256k1-flags-bit-compression+)
  "Flag to pass to secp256k1_ec_pubkey_serialize.")
...
(defcvar ("secp256k1_context_no_precomp" :read-only t) (:pointer (:struct secp256k1-context))
  "A simple secp256k1 context object with no precomputed tables. These are useful for
type serialization/parsing functions which require a context object to maintain
API consistency, but currently do not require expensive precomputations or dynamic allocations.")
...
(defcfun "secp256k1_scratch_space_create" (:pointer (:struct secp256k1-scratch-space))
...
In:     pubkey:     a pointer to a secp256k1_pubkey containing an
  ...
  (ctx (:pointer (:struct secp256k1-context)))
  (output (:pointer :uchar))
  (output-len (:pointer :size))
  (pubkey (:pointer (:struct secp256k1-pubkey)))
  (flags :uint))
...
(defcvar ("secp256k1_nonce_function_rfc6979" :read-only t) :pointer
  "An implementation of RFC6979 (using HMAC-SHA256) as nonce generation function.
If a data pointer is passed, it is assumed to be a pointer to 32 bytes of
extra entropy.")


(defcvar ("secp256k1_nonce_function_default" :read-only t) :pointer
...
(defcvar ("secp256k1_ecdh_hash_function_sha256" :read-only t) :pointer 
  "An implementation of SHA256 hash function that applies to compressed public key.
Populates the output parameter with 32 bytes.")

(defcvar ("secp256k1_ecdh_hash_function_default" :read-only t) :pointer 
...
In:   pubkey1:  first public key to compare
      pubkey2:  second public key to compare"
  (ctx (:pointer (:struct secp256k1-context)))
  (pubkey1 (:pointer (:struct secp256k1-xonly-pubkey)))
  (pubkey2 (:pointer (:struct secp256k1-xonly-pubkey))))
...
In: tweaked_pubkey32: pointer to a serialized xonly_pubkey.
  ...
  (ctx (:pointer (:struct secp256k1-context)))
  (tweaked-pubkey32 (:pointer :uchar))
...
(defcvar ("secp256k1_nonce_function_bip340" :read-only t) :pointer
